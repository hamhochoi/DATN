...
\graphicspath{ {./images/} }
\usepackage{url}
\urldef{\mailsa}\path|{dothanhwork2017, haiquan5396}@gmail.com|    
...
%\keywords{Internet of Things; ontology; cross-platform; interoperability; intergration; c%cross-domain applications.}
\end{abstract}
